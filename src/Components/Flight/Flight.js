...
class FormsDemo extends Component {
  ...
  this.state.app_key
}& format=json & source=DEL & destination=VTZ & dateofdeparture=20180902 & seatingclass=${
  this.state.tripClass
}& adults=${ this.state.adults }& children=${ this.state.children }& infants=${
  this.state.infant
}& counter=100`*/
  getData = () => {
    fetch(
      "https://fierce-castle-81936.herokuapp.com/https://developer.goibibo.com/api/search/?app_id=a4b1f9f8&app_key=3ef02fa6e90117990fcb719881a335b6&format=json&source=DEL&destination=VTZ&dateofdeparture=20180901&seatingclass=E&adults=1&children=0&infants=0&counter=100"
    )
